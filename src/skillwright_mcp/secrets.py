...
SECRET_PROVIDERS: frozenset[str] = frozenset({"env"})
...
class SecretResolver:
    """Resolve environment-backed secrets without caching plaintext values."""
    ...
    async def resolve(self, secret_ref: str, *, provider: str = "env") -> str:
        ...
        value = os.environ.get(secret_env_name(normalized_ref))
